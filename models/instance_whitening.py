...
def compute_cross_covariance_matrix(f_map1, f_map2, eye=None):
    eps = 1e-5
...
def cross_covariance_diagonal_loss(k_feat, q_feat):
    assert k_feat.shape == q_feat.shape

    f_cor, B = compute_cross_covariance_matrix(k_feat, q_feat)
